...
class ChatFragment : Fragment() {
    ...
    private fun setUpMessageList() {
        ...
        val options: FirebaseRecyclerOptions<UserMessage> = FirebaseRecyclerOptions.Builder<UserMessage>().setQuery(query){
    ...
    class ViewHolder(override val containerView: View) : RecyclerView.ViewHolder(containerView), LayoutContainer{
        ...
        fun bind(userMessage: UserMessage){
            with(userMessage){
                containerView.user_email.setText(email)
                containerView.user_message.setText(message)
            }
        }
    }
